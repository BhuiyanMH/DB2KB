	...
	public boolean getInput(JPanel panel, HashMap<String, LinkedHashSet<String>> inputParamsMap) {
		...
		btnNewDBPediaDataFile.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				String defaultName = commonMethods.getDateTime() + "_DBPediaData.json";
		...
		btnNewResFile.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				String defaultName = commonMethods.getDateTime() +"_"+midName+"_Resources.txt";

				String filePath = commonMethods.getSaveFile("", defaultName, "Select Directory to save Resources File");
		...
		if (confirmation == JOptionPane.OK_OPTION) {
			...
			if (selectedOperationIndex == 0) {
				...
				try {
					...
					if (!commonMethods.isIntParseable(temp)) {
						commonMethods.showMessage("Num of Hit must be a integer.");
						return false;
					}

					int numOfHit = commonMethods.getInt(temp);
