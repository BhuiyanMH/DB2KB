	...
	public boolean getInput(JPanel panel, HashMap<String, LinkedHashSet<String>> inputParamsMap) {
		...
		btnOpenMatcher.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String defaultName = commonMethods.getDateTime() + "_Matcher.txt";
		...
		btnOpenDBPediaSBag.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String filePath = commonMethods.getFilePath("Select DBpedia Semantic Bag File");
		...
		btnOpenLKSBag.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String filePath = commonMethods.getFilePath("Select Local KB Semantic Bag File");
		...
		btnOpenPWeightFile.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String filePath = commonMethods.getFilePath("Select Property Weight File");
		...
		if (confirmation == JOptionPane.OK_OPTION) {
			...
			try {
				...
				if (!commonMethods.hasEmptyString(inputList)) {
					...
					if (!commonMethods.isDoubleParseable(thresHoldString)) {
						commonMethods.showMessage("Please provide number for threshold.");
						return false;
					}

					if (matcherPath.equals("None")) {
						commonMethods.showMessage("Please give path for matcher file.");
						return false;

					}
					
					setThreshHold(commonMethods.getDouble(thresHoldString));
