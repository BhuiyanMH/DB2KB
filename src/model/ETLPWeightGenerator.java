...
//		}
		...
		btnNewPWeight.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String defaultName = commonMethods.getDateTime() + "_PWeight.txt";
...
//			public void actionPerformed(ActionEvent arg0) {
//				String filePath = commonMethods.getFilePath("Select Resource file to open");
//
//				if (!filePath.equals("")) {
//
			...
			try {
				...
				if (!commonMethods.hasEmptyString(inputList)) {
					...
					if (pweightFilePathString.equals("None")) {
						...
						commonMethods.showMessage("Please select path for saving Pweight file.");
						return false;
